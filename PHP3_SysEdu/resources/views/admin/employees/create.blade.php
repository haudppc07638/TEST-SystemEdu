...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <form class="row g-3 mt-3 needs-validation" novalidate action="{{ route('admin.employees.create.post') }}"  method="POST"enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="code" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="position" id="positionTeacher"
                            value="teacher" {{ old('position') == 'teacher' ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="position" id="positionOfficer"
                            value="admin" {{ old('position') == 'admin' ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('nation') is-invalid @enderror" name="nation" value="{{ old('nation') }}">
                    @error('nation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('educational_level') is-invalid @enderror" name="educational_level" value="{{ old('educational_level') }}">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('identity_card') is-invalid @enderror" name="identity_card" value="{{ old('identity_card') }}">
                    @error('identity_card')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('card_location') is-invalid @enderror" name="card_location" value="{{ old('card_location') }}">
                    @error('card_location')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('house_number') is-invalid @enderror" name="house_number" value="{{ old('house_number') }}">
                    @error('house_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('year_graduation') is-invalid @enderror" name="year_graduation" value="{{ old('year_graduation') }}">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('graduate') is-invalid @enderror" name="graduate" value="{{ old('graduate') }}">
                    @error('graduate')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('provice_city') is-invalid @enderror" name="provice_city" value="{{ old('provice_city') }}">
                    @error('provice_city')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('commune_level') is-invalid @enderror" name="commune_level" value="{{ old('commune_level') }}">
                    @error('commune_level')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
