...
@section('timeslots', 'Thêm Thời Gian')
...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <form class="mt-3" method="POST" action="{{ route('admin.timeslots.create.post') }}">
                @csrf
                <div class="row mb-3">
                    <label for="slot" class="col-sm-2 col-form-label">Ca</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('slot') is-invalid @enderror" id="slot" name="slot" value="{{ old('slot') }}">
                        @error('slot')
