...
<main class="h-full pb-16 overflow-y-auto">
  <div class="container grid px-6 mx-auto">
    ...
    <div class="mt-6 bg-gray-50 p-4 rounded-lg shadow">
        ...
        @if ($totalTuition->total_credit < 14)
            <p class="mt-4 text-sm text-red-600 font-semibold">
                Tổng số tín chỉ không đủ 14. Vui lòng đăng ký thêm môn học để đạt mức yêu cầu.
            </p>
        @elseif ($totalTuition->total_credit > 25)
            <p class="mt-4 text-sm text-red-600 font-semibold">
                Tổng số tín chỉ vượt mức cho phép (25 tín chỉ). Vui lòng điều chỉnh số tín chỉ trước khi thanh toán.
            </p>
        @else
