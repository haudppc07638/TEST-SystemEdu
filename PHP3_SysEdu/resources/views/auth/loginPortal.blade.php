                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul id="bsb-tpl-navbar" class="navbar-nav justify-content-end flex-grow-1">
                            <li class="nav-item">
                                <a class="nav-link fw-700" href="{{ route('login.admin') }}"
                                    data-bs-target="#offcanvasNavbar">Cán bộ đào tạo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login.teacher') }}"
                                    data-bs-target="#offcanvasNavbar">Giảng viên</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login.student') }}"
                                    data-bs-target="#offcanvasNavbar">Sinh viên</a>
                            </li>
                        </ul>
                    </div>
                </div>
